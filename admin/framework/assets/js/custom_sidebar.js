(function ($, window) {
	...
	TERMINUS_SIDEBAR.prototype = {
		...
		createRemoveButton: function () {
            this.widgetArea.find('.sidebar-terminus_custom').append('<span class="custom-sidebar-delete dashicons-trash"></span>');
        },
