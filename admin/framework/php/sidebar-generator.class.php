<?php
if (!class_exists('TERMINUS_SIDEBAR')) {

	class TERMINUS_SIDEBAR extends TERMINUS_FRAMEWORK {
		...
		function __construct($options) {
		    ...
		    $this->title = esc_html__('Terminus Custom Widget Area', 'terminus');
			$this->stored = 'terminus_sidebars';
		...
		public function enqueue_assets() {
			...
			wp_enqueue_script( 'terminus_custom_sidebar_js' , $this->paths['js'] . 'custom_sidebar.js');
			wp_enqueue_style( 'terminus_custom_sidebar_css' , $this->paths['css'] . 'custom_sidebar.css');
		}
		...
		public function add_field() {
			...
			$output .= "\n    <p><input size='30' type='text' value='' placeholder = '". esc_html__('Enter Name for new Widget Area', 'terminus') ."' name='form-add-widget' /></p>";
			$output .= "\n    <input class='button button-primary' type='submit' value='". esc_html__('Add Widget Area', 'terminus') ."' />";
