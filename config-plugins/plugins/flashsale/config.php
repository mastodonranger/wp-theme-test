...
if (!class_exists('TERMINUS_FLASHSALE_MOD')) {
	...
	class TERMINUS_FLASHSALE_MOD extends TERMINUS_PLUGINS_CONFIG {
		...
		public function enqueue_styles_scripts() {
			...
			if ( !is_admin() ) {
				$frontend_css = $this->paths['BASE_URI'] . 'flashsale/css/jquery.countdown.css';
		...
		public function woocommerce_flash_sale_add_tab_woocommerce ($tabs) {
			...
			$tabs['flash_sale'] = esc_html__('Flash Sale', 'terminus');
			return $tabs;
		}
		...
		public function woocommerce_brands_plugin_options() {
			$options['general_settings'] = array(
				array(
					'name' => esc_html__( 'General Settings', 'terminus' ),
					'type' => 'title',
					'desc' => '',
					'id' => 'pw_woocommerce_brands_general_settings'
				),
				array(
					'name'      => esc_html__( 'Show Count Down Single', 'terminus' ),
					'desc'      => esc_html__( 'Show Count Down Single.', 'terminus'),
				...
				array(
					'name'      => esc_html__( 'Show Count Down Archive', 'terminus' ),
					'desc'      => esc_html__( 'Show Count Down Archive', 'terminus'),
