...
if (!class_exists('TERMINUS_DROPDOWN_CART')) {

	class TERMINUS_DROPDOWN_CART {

		public $action_cart_item_remove = 'terminus_cart_item_remove';
		public $action_refresh_cart_fragment = 'terminus_refresh_cart_fragment';
