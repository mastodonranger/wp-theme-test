...
if ( !function_exists('terminus_get_term_from_query_var') ) {

	function terminus_get_term_from_query_var() {
...
if ( !function_exists('terminus_get_meta_value') ) {

	function terminus_get_meta_value($meta_key) {

		$value = '';

		if ( terminus_is_product_category() ) {

			$term = terminus_get_term_from_query_var();
