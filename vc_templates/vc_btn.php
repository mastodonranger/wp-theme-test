...
$outline_custom_hover_text = $add_icon = $i_align = $i_type = $i_icon_entypo = $i_icon_fontawesome = $i_icon_linecons = $i_icon_pixelicons = $i_icon_typicons = $css = $css_animation = $animation_delay = $scroll_factor = '';
...
if ( '' !== $css_animation  ) {
	$wrapper_classes[] = 'terminus_animated';
